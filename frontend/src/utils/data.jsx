...
export const counts = [
  {
    ...
    icon: <LocalFireDepartmentRounded sx={{ color: "yellow", fontSize: "26px" }} />,
  ...
  {
    name: "Workouts",
    icon: <FitnessCenterRounded sx={{ color: "red", fontSize: "26px" }} />,
  ...
  },
  {
    ...
    icon: <TimelineRounded sx={{ color: "green", fontSize: "26px" }} />,
